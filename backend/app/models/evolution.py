...
class EvolutionEvent(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    ollama_analysis: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
...
class PopulationEvent(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    report: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)  # extinction/generation research report
